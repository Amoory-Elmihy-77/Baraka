  ...
  useEffect(() => {
    if (task) {
      setFormData({
        ...
        prayerTime: task.prayerTime || 'Fajr',
        category: task.category || 'important_urgent',
      });
    }
  }, [task]);
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={3}
            className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none resize-none"
